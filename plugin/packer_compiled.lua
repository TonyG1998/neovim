...
_G.packer_plugins = {
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/cmp-calc",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["cmp-rg"] = {
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/cmp-rg",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
    url = "https://github.com/rebelot/kanagawa.nvim"
  },
  ["leap.nvim"] = {
    config = { 'require("config/leap")' },
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["noice.nvim"] = {
    ...
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/noice.nvim",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/Users/tony/.local/share/nvim/site/pack/packer/start/nvim-notify",
